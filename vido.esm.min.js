 ...
 * subject to an additional IP rights grant found at
 * http://polymer.github.io/PATENTS.txt
 */const I=new class{handleAttributeExpressions(e,t,n,o){const s=t[0];if("."===s){return new T(e,t.slice(1),n).parts}return"@"===s?[new S(e,t.slice(1),o.eventContext)]:"?"===s?[new V(e,t.slice(1),n)]:new N(e,t,n).parts}handleTextExpression(e){return new A(e)}};
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
