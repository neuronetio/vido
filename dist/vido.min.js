 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */const{H:W}=U,j=(t,e)=>{var s,n;return void 0===e?void 0!==(null===(s=t)||void 0===s?void 0:s._$litType$):(null===(n=t)||void 0===n?void 0:n._$litType$)===e},z=t=>void 0===t.strings,F=()=>document.createComment(""),V=(t,e,s)=>{var n;const i=t._$AA.parentNode,o=void 0===e?t._$AB:e._$AA;if(void 0===s){const e=i.insertBefore(F(),o),n=i.insertBefore(F(),o);s=new W(e,n,t,t.options)}else{const e=s._$AB.nextSibling,r=s._$AM,h=r!==t;if(h){let e;null===(n=s._$AQ)||void 0===n||n.call(s,t),s._$AM=t,void 0!==s._$AP&&(e=t._$AU)!==r._$AU&&s._$AP(e)}if(e!==o||h){let t=s._$AA;for(;t!==e;){const e=t.nextSibling;i.insertBefore(t,o),t=e}}}return s},G=(t,e,s=t)=>(t._$AI(e,s),t),K={},q=(t,e=K)=>t._$AH=e,Z=t=>t._$AH,J=t=>{var e;null===(e=t._$AP)||void 0===e||e.call(t,!1,!0);let s=t._$AA;const n=t._$AB.nextSibling;for(;s!==n;){const t=s.nextSibling;s.remove(),s=t}},Q=t=>{t._$AR()},tt=(t,e)=>{var s,n;const i=t._$AN;if(void 0===i)return!1;for(const t of i)null===(n=(s=t)._$AO)||void 0===n||n.call(s,e,!1),tt(t,e);return!0},et=t=>{let e,s;do{if(void 0===(e=t._$AM))break;s=e._$AN,s.delete(t),t=e}while(0===(null==s?void 0:s.size))},st=t=>{for(let e;e=t._$AM;t=e){let s=e._$AN;if(void 0===s)e._$AN=s=new Set;else if(s.has(t))break;s.add(t),ot(e)}};
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */class ct extends rt{constructor(){super(...arguments),this._$CG=new ht(this),this._$CK=new lt}render(t,e){return _}update(t,[e,s]){if(this.isConnected||this.disconnected(),e===this._$CX)return;this._$CX=e;let n=0;const{_$CG:i,_$CK:o}=this;return(async(t,e)=>{for await(const s of t)if(!1===await e(s))return})(e,(async t=>{for(;o.get();)await o.get();const r=i.deref();if(void 0!==r){if(r._$CX!==e)return!1;void 0!==s&&(t=s(t,n)),r.commitValue(t,n),n++}return!0})),_}commitValue(t,e){this.setValue(t)}disconnected(){this._$CG.disconnect(),this._$CK.pause()}reconnected(){this._$CG.reconnect(this),this._$CK.resume()}}const at=R(ct),dt=R(class extends ct{constructor(t){if(super(t),t.type!==k.CHILD)throw Error("asyncAppend can only be used in child expressions")}update(t,e){return this._$CJ=t,super.update(t,e)}commitValue(t,e){0===e&&Q(this._$CJ);const s=V(this._$CJ);G(s,t)}}),ut=R(class extends O{constructor(t){super(t),this.tt=new WeakMap}render(t){return[t]}update(t,[e]){if(j(this.it)&&(!j(e)||this.it.strings!==e.strings)){const e=Z(t).pop();let s=this.tt.get(this.it.strings);if(void 0===s){const t=document.createDocumentFragment();s=C(b,t),s.setConnected(!1),this.tt.set(this.it.strings,s)}q(s,[e]),V(s,void 0,e)}if(j(e)){if(!j(this.it)||this.it.strings!==e.strings){const s=this.tt.get(e.strings);if(void 0!==s){const e=Z(s).pop();Q(t),V(t,void 0,e),q(t,[e])}}this.it=e}else this.it=void 0;return this.render(e)}}),pt={},vt=R(class extends O{constructor(){super(...arguments),this.nt=pt}render(t,e){return e()}update(t,[e,s]){if(Array.isArray(e)){if(Array.isArray(this.nt)&&this.nt.length===e.length&&e.every(((t,e)=>t===this.nt[e])))return _}else if(this.nt===e)return _;return this.nt=Array.isArray(e)?Array.from(e):e,this.render(e,s)}}),yt=t=>null!=t?t:b
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */,mt=(t,e,s)=>{const n=new Map;for(let i=e;i<=s;i++)n.set(t[i],i);return n},ft=R(class extends O{constructor(t){if(super(t),t.type!==k.CHILD)throw Error("repeat() can only be used in text expressions")}dt(t,e,s){let n;void 0===s?s=e:void 0!==e&&(n=e);const i=[],o=[];let r=0;for(const e of t)i[r]=n?n(e,r):r,o[r]=s(e,r),r++;return{values:o,keys:i}}render(t,e,s){return this.dt(t,e,s).values}update(t,[e,s,n]){var i;const o=Z(t),{values:r,keys:h}=this.dt(e,s,n);if(!Array.isArray(o))return this.ut=h,r;const l=null!==(i=this.ut)&&void 0!==i?i:this.ut=[],c=[];let a,d,u=0,p=o.length-1,v=0,y=r.length-1;for(;u<=p&&v<=y;)if(null===o[u])u++;else if(null===o[p])p--;else if(l[u]===h[v])c[v]=G(o[u],r[v]),u++,v++;else if(l[p]===h[y])c[y]=G(o[p],r[y]),p--,y--;else if(l[u]===h[y])c[y]=G(o[u],r[y]),V(t,c[y+1],o[u]),u++,y--;else if(l[p]===h[v])c[v]=G(o[p],r[v]),V(t,o[u],o[p]),p--,v++;else if(void 0===a&&(a=mt(h,v,y),d=mt(l,u,p)),a.has(l[u]))if(a.has(l[p])){const e=d.get(h[v]),s=void 0!==e?o[e]:null;if(null===s){const e=V(t,o[u]);G(e,r[v]),c[v]=e}else c[v]=G(s,r[v]),V(t,o[u],s),o[e]=null;v++}else J(o[p]),p--;else J(o[u]),u++;for(;v<=y;){const e=V(t,c[y+1]);G(e,r[v]),c[v++]=e}for(;u<=p;){const t=o[u++];null!==t&&J(t)}return this.ut=h,q(t,c),_}});
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
