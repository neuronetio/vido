 ...
 * subject to an additional IP rights grant found at
 * http://polymer.github.io/PATENTS.txt
 */let f;const b=` ${l} `,x=document.createElement("template");class _{constructor(t,e,n,s){this.strings=t,this.values=e,this.type=n,this.processor=s}getHTML(){const t=this.strings.length-1;let e="",n=!1;for(let s=0;s<t;s++){const t=this.strings[s],o=t.lastIndexOf("\x3c!--");n=(o>-1||n)&&-1===t.indexOf("--\x3e",o+1);const i=g.exec(t);e+=null===i?t+(n?b:c):t.substr(0,i.index)+i[1]+i[2]+"$lit$"+i[3]+l}return e+=this.strings[t],e}getTemplateElement(){const t=x.cloneNode();return t.innerHTML=function(t){const e=window,n=e.trustedTypes||e.TrustedTypes;return n&&!f&&(f=n.createPolicy("lit-html",{createHTML:t=>t})),f?f.createHTML(t):t}(this.getHTML()),t}}class w extends _{getHTML(){return`<svg>${super.getHTML()}</svg>`}getTemplateElement(){const t=super.getTemplateElement(),e=t.content,n=e.firstChild;return e.removeChild(n),o(e,n.firstChild),t}}
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 ...
 * subject to an additional IP rights grant found at
 * http://polymer.github.io/PATENTS.txt
 */;class ${handleAttributeExpressions(t,e,n,s,o){const i=e[0];if("."===i){return new X(t,e.slice(1),n,o).parts}return"@"===i?[new k(t,e.slice(1),s.eventContext)]:"?"===i?[new C(t,e.slice(1),n)]:new M(t,e,n,o).parts}handleTextExpression(t,e){return new Y(t,e)}}const z=new $;
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 ...
 * subject to an additional IP rights grant found at
 * http://polymer.github.io/PATENTS.txt
 */"undefined"!=typeof window&&(window.litHtmlVersions||(window.litHtmlVersions=[])).push("1.1.7");const U=(t,...e)=>new _(t,e,"html",z),O=(t,...e)=>new w(t,e,"svg",z);var H=Object.freeze({__proto__:null,html:U,svg:O,DefaultTemplateProcessor:$,defaultTemplateProcessor:z,directive:t,Directive:e,isDirective:n,removeNodes:i,reparentNodes:o,noChange:r,nothing:a,AttributeCommitter:M,AttributePart:T,BooleanAttributePart:C,EventPart:k,isIterable:P,isPrimitive:N,NodePart:Y,PropertyCommitter:X,PropertyPart:V,get sanitizerFactory(){return A},setSanitizerFactory:t=>{if(A!==I)throw new Error("Attempted to overwrite existing lit-html security policy. setSanitizeDOMValueFactory should be called at most once.");A=t},parts:B,render:W,templateCaches:F,templateFactory:R,TemplateInstance:y,SVGTemplateResult:w,TemplateResult:_,createMarker:v,isTemplatePartActive:u,Template:d}),j=function(t){if(!Symbol.asyncIterator)throw new TypeError("Symbol.asyncIterator is not defined.");var e,n=t[Symbol.asyncIterator];return n?n.call(t):(t="function"==typeof __values?__values(t):t[Symbol.iterator](),e={},s("next"),s("throw"),s("return"),e[Symbol.asyncIterator]=function(){return this},e);function s(n){e[n]=t[n]&&function(e){return new Promise((function(s,o){(function(t,e,n,s){Promise.resolve(s).then((function(e){t({value:e,done:n})}),e)})(s,o,(e=t[n](e)).done,e.value)}))}}};
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 ...
 * subject to an additional IP rights grant found at
 * http://polymer.github.io/PATENTS.txt
 */const q=t((t,e)=>async n=>{var s,o;if(!(n instanceof Y))throw new Error("asyncAppend can only be used in text bindings");if(t===n.value)return;let i;n.value=t;let r=0;try{for(var a,l=j(t);!(a=await l.next()).done;){let s=a.value;if(n.value!==t)break;0===r&&n.clear(),void 0!==e&&(s=e(s,r));let o=n.startNode;void 0!==i&&(o=v(),i.endNode=o,n.endNode.parentNode.insertBefore(o,n.endNode)),i=new Y(n.options,n.templatePart),i.insertAfterNode(o),i.setValue(s),i.commit(),r++}}catch(t){s={error:t}}finally{try{a&&!a.done&&(o=l.return)&&await o.call(l)}finally{if(s)throw s.error}}});
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 ...
 * subject to an additional IP rights grant found at
 * http://polymer.github.io/PATENTS.txt
 */var G=function(t){if(!Symbol.asyncIterator)throw new TypeError("Symbol.asyncIterator is not defined.");var e,n=t[Symbol.asyncIterator];return n?n.call(t):(t="function"==typeof __values?__values(t):t[Symbol.iterator](),e={},s("next"),s("throw"),s("return"),e[Symbol.asyncIterator]=function(){return this},e);function s(n){e[n]=t[n]&&function(e){return new Promise((function(s,o){(function(t,e,n,s){Promise.resolve(s).then((function(e){t({value:e,done:n})}),e)})(s,o,(e=t[n](e)).done,e.value)}))}}};const Z=t((t,e)=>async n=>{var s,o;if(!(n instanceof Y))throw new Error("asyncReplace can only be used in text bindings");if(t===n.value)return;const i=new Y(n.options,n.templatePart);n.value=t;let r=0;try{for(var a,l=G(t);!(a=await l.next()).done;){let s=a.value;if(n.value!==t)break;0===r&&(n.clear(),i.appendIntoPart(n)),void 0!==e&&(s=e(s,r)),i.setValue(s),i.commit(),r++}}catch(t){s={error:t}}finally{try{a&&!a.done&&(o=l.return)&&await o.call(l)}finally{if(s)throw s.error}}}),J=new WeakMap,K=t(t=>e=>{if(!(e instanceof Y))throw new Error("cache can only be used in text bindings");let n=J.get(e);void 0===n&&(n=new WeakMap,J.set(e,n));const s=e.value;if(s instanceof y){if(t instanceof _&&s.template===e.options.templateFactory(t))return void e.setValue(t);{let t=n.get(s.template);void 0===t&&(t={instance:s,nodes:document.createDocumentFragment()},n.set(s.template,t)),o(t.nodes,e.startNode.nextSibling,e.endNode)}}if(t instanceof _){const s=e.options.templateFactory(t),o=n.get(s);void 0!==o&&(e.setValue(o.nodes),e.commit(),e.value=o.instance)}e.setValue(t)}),Q=new WeakMap,tt=t(t=>e=>{if(!(e instanceof T)||e instanceof V||"class"!==e.committer.name||e.committer.parts.length>1)throw new Error("The `classMap` directive must be used in the `class` attribute and must be the only part in the attribute.");const{committer:n}=e,{element:s}=n;let o=Q.get(e);void 0===o&&(s.className=n.strings.join(" "),Q.set(e,o=new Set));const{classList:i}=s;o.forEach(e=>{e in t||(i.remove(e),o.delete(e))});for(const e in t){const n=t[e];n!=o.has(e)&&(n?(i.add(e),o.add(e)):(i.remove(e),o.delete(e)))}}),et=new WeakMap,nt=t((t,e)=>n=>{const s=et.get(n);if(Array.isArray(t)){if(Array.isArray(s)&&s.length===t.length&&t.every((t,e)=>t===s[e]))return}else if(s===t&&(void 0!==t||et.has(n)))return;n.setValue(e()),et.set(n,Array.isArray(t)?Array.from(t):t)}),st=t(t=>e=>{if(void 0===t&&e instanceof T){if(t!==e.value){const t=e.committer.name;e.committer.element.removeAttribute(t)}}else e.setValue(t)}),ot=(t,e)=>{const n=t.startNode.parentNode,s=null==e?t.endNode:e.startNode,o=n.insertBefore(v(),s);n.insertBefore(v(),s);const i=new Y(t.options,void 0);return i.insertAfterNode(o),i},it=(t,e)=>(t.setValue(e),t.commit(),t),rt=(t,e,n)=>{const s=t.startNode.parentNode,i=n?n.startNode:t.endNode,r=e.endNode.nextSibling;r!==i&&o(s,e.startNode,r,i)},at=t=>{i(t.startNode.parentNode,t.startNode,t.endNode.nextSibling)},lt=(t,e,n)=>{const s=new Map;for(let o=e;o<=n;o++)s.set(t[o],o);return s},ct=new WeakMap,ht=new WeakMap,dt=t((t,e,n)=>{let s;return void 0===n?n=e:void 0!==e&&(s=e),e=>{if(!(e instanceof Y))throw new Error("repeat can only be used in text bindings");const o=ct.get(e)||[],i=ht.get(e)||[],r=[],a=[],l=[];let c,h,d=0;for(const e of t)l[d]=s?s(e,d):d,a[d]=n(e,d),d++;let p=0,u=o.length-1,m=0,v=a.length-1;for(;p<=u&&m<=v;)if(null===o[p])p++;else if(null===o[u])u--;else if(i[p]===l[m])r[m]=it(o[p],a[m]),p++,m++;else if(i[u]===l[v])r[v]=it(o[u],a[v]),u--,v--;else if(i[p]===l[v])r[v]=it(o[p],a[v]),rt(e,o[p],r[v+1]),p++,v--;else if(i[u]===l[m])r[m]=it(o[u],a[m]),rt(e,o[u],o[p]),u--,m++;else if(void 0===c&&(c=lt(l,m,v),h=lt(i,p,u)),c.has(i[p]))if(c.has(i[u])){const t=h.get(l[m]),n=void 0!==t?o[t]:null;if(null===n){const t=ot(e,o[p]);it(t,a[m]),r[m]=t}else r[m]=it(n,a[m]),rt(e,n,o[p]),o[t]=null;m++}else at(o[u]),u--;else at(o[p]),p++;for(;m<=v;){const t=ot(e,r[v+1]);it(t,a[m]),r[m++]=t}for(;p<=u;){const t=o[p++];null!==t&&at(t)}ct.set(e,r),ht.set(e,l)}}),pt=new WeakMap,ut=document.createElement("template"),mt=t(t=>e=>{if(!(e instanceof Y))throw new Error("unsafeHTML can only be used in text bindings");const n=pt.get(e);if(void 0!==n&&N(t)&&t===n.value&&e.value===n.fragment)return;const s=ut.cloneNode();s.innerHTML=t;const o=document.importNode(s.content,!0);e.setValue(o),pt.set(e,{value:t,fragment:o})}),vt=new WeakMap,gt=t((...t)=>e=>{let n=vt.get(e);void 0===n&&(n={lastRenderedIndex:2147483647,values:[]},vt.set(e,n));const s=n.values;let o=s.length;n.values=t;for(let i=0;i<t.length&&!(i>n.lastRenderedIndex);i++){const r=t[i];if(N(r)||"function"!=typeof r.then){e.setValue(r),n.lastRenderedIndex=i;break}i<o&&r===s[i]||(n.lastRenderedIndex=2147483647,o=0,Promise.resolve(r).then(t=>{const s=n.values.indexOf(r);s>-1&&s<n.lastRenderedIndex&&(n.lastRenderedIndex=s,e.setValue(t),e.commit())}))}}),yt=new WeakMap;
/**
 * @license
