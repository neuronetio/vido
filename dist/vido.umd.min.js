...
/**
     ...
     * Copyright 2017 Google LLC
     * SPDX-License-Identifier: BSD-3-Clause
     */const Ct=W(class extends ct{constructor(){super(...arguments),this._$Cwt=1073741823,this._$Cyt=[],this._$CG=new at(this),this._$CK=new dt}render(...t){var e;return null!==(e=t.find((t=>!xt(t))))&&void 0!==e?e:_}update(t,e){const s=this._$Cyt;let n=s.length;this._$Cyt=e;const i=this._$CG,o=this._$CK;this.isConnected||this.disconnected();for(let t=0;t<e.length&&!(t>this._$Cwt);t++){const r=e[t];if(!xt(r))return this._$Cwt=t,r;t<n&&r===s[t]||(this._$Cwt=1073741823,n=0,Promise.resolve(r).then((async t=>{for(;o.get();)await o.get();const e=i.deref();if(void 0!==e){const s=e._$Cyt.indexOf(r);s>-1&&s<e._$Cwt&&(e._$Cwt=s,e.setValue(t))}})))}return _}disconnected(){this._$CG.disconnect(),this._$CK.pause()}reconnected(){this._$CG.reconnect(this),this._$CK.resume()}}),wt=W(class extends z{constructor(t){if(super(t),t.type!==j&&t.type!==B&&t.type!==R)throw Error("The `live` directive is not allowed on child or event bindings");if(!G(t))throw Error("`live` bindings can only contain a single expression")}render(t){return t}update(t,[e]){if(e===_||e===b)return e;const s=t.element,n=t.name;if(t.type===j){if(e===s[n])return _}else if(t.type===R){if(!!e===s.hasAttribute(n))return _}else if(t.type===B&&s.getAttribute(n)===e+"")return _;return Q(t),e}}),Mt=new WeakMap;
/**
     * @license
     * Copyright 2020 Google LLC
     * SPDX-License-Identifier: BSD-3-Clause
