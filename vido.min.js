...
/**
     ...
     * subject to an additional IP rights grant found at
     * http://polymer.github.io/PATENTS.txt
     */const P=new class{handleAttributeExpressions(e,t,n,o){const s=t[0];if("."===s){return new C(e,t.slice(1),n).parts}return"@"===s?[new S(e,t.slice(1),o.eventContext)]:"?"===s?[new T(e,t.slice(1),n)]:new A(e,t,n).parts}handleTextExpression(e){return new V(e)}};
/**
     * @license
     * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
     * This code may only be used under the BSD style license found at
...
/**
     ...
     * http://polymer.github.io/PATENTS.txt
     */
var F=function(e){if(!Symbol.asyncIterator)throw new TypeError("Symbol.asyncIterator is not defined.");var t,n=e[Symbol.asyncIterator];return n?n.call(e):(e="function"==typeof __values?__values(e):e[Symbol.iterator](),t={},o("next"),o("throw"),o("return"),t[Symbol.asyncIterator]=function(){return this},t);function o(n){t[n]=e[n]&&function(t){return new Promise((function(o,s){(function(e,t,n,o){Promise.resolve(o).then((function(t){e({value:t,done:n})}),t)})(o,s,(t=e[n](t)).done,t.value)}))}}};const R=n((e,t)=>async n=>{var o,s;if(!(n instanceof V))throw new Error("asyncAppend can only be used in text bindings");if(e===n.value)return;let i;n.value=e;let r=0;try{for(var a,l=F(e);!(a=await l.next()).done;){let o=a.value;if(n.value!==e)break;0===r&&n.clear(),void 0!==t&&(o=t(o,r));let s=n.startNode;void 0!==i&&(s=g(),i.endNode=s,n.endNode.parentNode.insertBefore(s,n.endNode)),(i=new V(n.options)).insertAfterNode(s),i.setValue(o),i.commit(),r++}}catch(e){o={error:e}}finally{try{a&&!a.done&&(s=l.return)&&await s.call(l)}finally{if(o)throw o.error}}});
/**
     * @license
     * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
     * This code may only be used under the BSD style license found at
