...
/**
     ...
     * subject to an additional IP rights grant found at
     * http://polymer.github.io/PATENTS.txt
     */const I=new class{handleAttributeExpressions(e,t,n,o){const s=t[0];if("."===s){return new T(e,t.slice(1),n).parts}return"@"===s?[new M(e,t.slice(1),o.eventContext)]:"?"===s?[new V(e,t.slice(1),n)]:new N(e,t,n).parts}handleTextExpression(e){return new E(e)}};
/**
     * @license
     * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
     * This code may only be used under the BSD style license found at
...
/**
     ...
     * http://polymer.github.io/PATENTS.txt
     */
var H=function(e){if(!Symbol.asyncIterator)throw new TypeError("Symbol.asyncIterator is not defined.");var t,n=e[Symbol.asyncIterator];return n?n.call(e):(e="function"==typeof __values?__values(e):e[Symbol.iterator](),t={},o("next"),o("throw"),o("return"),t[Symbol.asyncIterator]=function(){return this},t);function o(n){t[n]=e[n]&&function(t){return new Promise((function(o,s){(function(e,t,n,o){Promise.resolve(o).then((function(t){e({value:t,done:n})}),t)})(o,s,(t=e[n](t)).done,t.value)}))}}};const R=t((e,t)=>async n=>{var o,s;if(!(n instanceof E))throw new Error("asyncAppend can only be used in text bindings");if(e===n.value)return;let i;n.value=e;let r=0;try{for(var a,l=H(e);!(a=await l.next()).done;){let o=a.value;if(n.value!==e)break;0===r&&n.clear(),void 0!==t&&(o=t(o,r));let s=n.startNode;void 0!==i&&(s=f(),i.endNode=s,n.endNode.parentNode.insertBefore(s,n.endNode)),(i=new E(n.options)).insertAfterNode(s),i.setValue(o),i.commit(),r++}}catch(e){o={error:e}}finally{try{a&&!a.done&&(s=l.return)&&await s.call(l)}finally{if(o)throw o.error}}});
/**
     * @license
     * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
     * This code may only be used under the BSD style license found at
...
/**
     ...
     * subject to an additional IP rights grant found at
     * http://polymer.github.io/PATENTS.txt
     */function de(e){return e&&"object"==typeof e&&!Array.isArray(e)}function ue(e){if(void 0!==e.actions){const t=e.actions.map(e=>{const t=Object.assign({},e),n=Object.assign({},t.props);return delete n.state,delete n.api,delete t.element,t.props=n,t});e.actions=t}return function e(t,...n){const o=n.shift();if(de(t)&&de(o))for(const n in o)if(de(o[n]))void 0===t[n]&&(t[n]={}),t[n]=e(t[n],o[n]);else if(Array.isArray(o[n])){t[n]=[];for(let s of o[n])de(s)?t[n].push(e({},s)):t[n].push(s)}else t[n]=o[n];return n.length?e(t,...n):t}({},e)}return function(e,n){let o=0;const s={};let i,r,a=[],l={},c=0;const d=Promise.resolve();function u(e){return t((function(t,n){return function(o){const s=o.committer.element;for(const o of t)if("function"==typeof o){let t;if(void 0!==l[e])for(const n of l[e])if(n.componentAction.create===o&&n.element===s){t=n;break}if(t)t.props=n;else{void 0!==s.__vido__&&delete s.__vido__;const t={instance:e,componentAction:{create:o,update(){},destroy(){}},element:s,props:n};a.push(t),void 0===l[e]&&(l[e]=[]),l[e].push(t)}}}}))}const p={debug:!1,state:e,api:n,html:L,svg:W,directive:t,asyncAppend:R,asyncReplace:B,cache:q,classMap:G,guard:K,ifDefined:Q,repeat:oe,styleMap:ie,unsafeHTML:ae,until:ce,lastProps:{},actions(e,t){},onDestroy(){},onChange(e){},reuseComponents(e,t,n,o){const s=[];if(e.length<t.length){let i=t.length-e.length;for(;i;){const r=t[t.length-i],a=p.createComponent(o,n(r));e.push(a),s.push(a.instance),i--}}else if(e.length>t.length){let n=e.length-t.length;for(;n;){const t=e.length-n;s.push(e[t].instance),e[t].destroy(),n--}e.length=t.length}let i=0;for(const o of e){const e=t[i];s.includes(o.instance)||o.change(n(e)),i++}return e},createComponent(e,t){const n=e.name+":"+o++;let i;let r=[];let l=[];i=Object.assign(Object.assign({},p),{update:function(){p.updateTemplate(i)},onDestroy:function(e){r.push(e)},onChange:function(e){l.push(e)},instance:n,actions:u(n),lastProps:t});const c=function(e,t,n){return{instance:e,vidoInstance:t,props:n,destroy:()=>(t.debug&&(console.groupCollapsed(`destroying component ${e}`),console.log(ue({components:Object.keys(s),actions:a})),console.trace(),console.groupEnd()),p.destroyComponent(e,t)),update:()=>(t.debug&&(console.groupCollapsed(`updating component ${e}`),console.log(ue({components:Object.keys(s),actions:a})),console.trace(),console.groupEnd()),p.updateTemplate(t)),change(o){t.debug&&(console.groupCollapsed(`changing component ${e}`),console.log(ue({props:n,_props:o,components:Object.keys(s),actions:a})),console.trace(),console.groupEnd()),s[e].change(o,t)},html:(n={})=>s[e].update(n,t)}}(n,i,t),d=e(i,t),h={instance:n,vidoInstance:i,lastProps:t,destroy(){i.debug&&(console.groupCollapsed(`component destroy method fired ${n}`),console.log(ue({props:t,components:Object.keys(s),destroyable:r,actions:a})),console.trace(),console.groupEnd());for(const e of r)e();l=[],r=[]},update:e=>(i.debug&&(console.groupCollapsed(`component update method fired ${n}`),console.log(ue({components:Object.keys(s),actions:a})),console.trace(),console.groupEnd()),d(e)),change(e){t=e,i.debug&&(console.groupCollapsed(`component change method fired ${n}`),console.log(ue({props:t,components:Object.keys(s),onChangeFunctions:l,changedProps:e,actions:a})),console.trace(),console.groupEnd());for(const t of l)t(e)}};return s[n]=h,s[n].change(t),i.debug&&(console.groupCollapsed(`component created ${n}`),console.log(ue({props:t,components:Object.keys(s),actions:a})),console.trace(),console.groupEnd()),c},destroyComponent(e,t){t.debug&&(console.groupCollapsed(`destroying component ${e}...`),console.log(ue({components:Object.keys(s),actions:a})),console.trace(),console.groupEnd()),a=a.filter(t=>(t.instance===e&&"function"==typeof t.componentAction.destroy&&t.componentAction.destroy(t.element,t.props),t.instance!==e)),delete l[e],s[e].destroy(),delete s[e],t.debug&&(console.groupCollapsed(`component destroyed ${e}`),console.log(ue({components:Object.keys(s),actions:a})),console.trace(),console.groupEnd())},updateTemplate(e){const t=++c,n=this;d.then((function(){t===c&&(n.render(),c=0,e.debug&&(console.groupCollapsed("templates updated"),console.trace(),console.groupEnd()))}))},createApp(e,t){r=t;const n=this.createComponent(e);return i=n.instance,this.render(),n},executeActions(){for(const e of a)if(void 0===e.element.__vido__){if("function"==typeof e.componentAction.create){const t=e.componentAction.create(e.element,e.props);p.debug&&(console.groupCollapsed(`create action executed ${e.instance}`),console.log(ue({components:Object.keys(s),action:e,actions:a})),console.trace(),console.groupEnd()),void 0!==t&&("function"==typeof t.update&&(e.componentAction.update=t.update),"function"==typeof t.destroy&&(e.componentAction.destroy=t.destroy))}}else"function"==typeof e.componentAction.update&&(e.componentAction.update(e.element,e.props),p.debug&&(console.groupCollapsed(`update action executed ${e.instance}`),console.log(ue({components:Object.keys(s),action:e,actions:a})),console.trace(),console.groupEnd()));for(const e of a)e.element.__vido__={instance:e.instance,props:e.props}},render(){$(s[i].update(),r),p.executeActions()}};return p}}));
